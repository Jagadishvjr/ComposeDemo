...
sealed interface Validators {
    ...
    /**
     * This is an phone validator. It will return true if the string value is a valid phone number. The implementation makes use of the [android.util.Patterns] class to match the phone number.
